    ...
    async loadConfiguration() {
        try {
            ...
            if (process.env.NODE_ENV === 'production') {
                ...
                // In development, fall back to environment variables or the original config
                config.apiKey = process.env.GOOGLE_TRANSLATE_API_KEY || 'AIzaSyDhqbYAxqrtNL4llvVCEuvFR057ukxY0Fk';
                config.apiSecret = process.env.API_SECRET || '230f6c1a5174936a916280a2203fb16035156e8ded92b76aed99923501be0974';
                config.serpApiKey = process.env.SERPAPI_KEY || 'b8cccfc8ac2095532f5acdbb8d277cd5386f4f339a489b688accfcf284f7f6b5';
                config.serperApiKey = process.env.SERPER_API_KEY || 'dd23c03abf07cac6a91523505592da72eb9db3fe';
                config.postmarkApiKey = process.env.POSTMARK_API_KEY || '50ece539-7bf4-4ca9-89a8-746ae50bccd7';
                config.sharedSecret = process.env.SHARED_SECRET || '0053e64510e622ac45aa7462fc838b8f0325a0fb';
            }
