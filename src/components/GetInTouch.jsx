...
const GetInTouch = () => {
  return (
    <section className="flex flex-col justify-center items-center py-32 w-full bg-gray-100 border-b border-solid border-b-red-600 max-md:py-24 max-md:max-w-full">
      <div className="flex flex-col items-start pr-20 max-w-full w-[692px] max-md:pr-5">
        ...
        <div className="flex z-10 flex-wrap gap-10 mt-2 text-red-600">
          <div className="chinese self-start text-7xl font-medium leading-[86px] tracking-[2.16px] max-md:text-4xl max-md:leading-[53px]">
            联<br />系<br />我<br />们
          </div>
          <ContactForm />
        </div>
