    ...
    <section className="w-full flex flex-col py-16">
      <div className="flex flex-col items-center">
        ...
        <div className="mt-8 space-y-6 font-body-01 text-center">
          <p>
            The FIREWALL dual-search engine will automatically translate your query, and provide
            image results from both Google and Baidu. Compare the image results side by side, and
            vote on whether you believe the results are being censored, manipulated, or lost in
            translation!
          </p>
          <p>
            The goal of this art project is to educate the public about internet freedom and
            censorship.
          </p>
        </div>
        <Link
