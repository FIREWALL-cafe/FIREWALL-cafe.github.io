...
const iso3to2 = {
    ...
    'IND': 'IN', 'BRA': 'BR', 'MEX': 'MX', 'ESP': 'ES',
    'ITA': 'IT', 'NLD': 'NL', 'BEL': 'BE', 'CHE': 'CH',
    'SWE': 'SE', 'NOR': 'NO', 'DNK': 'DK', 'FIN': 'FI',
    'AUT': 'AT', 'POL': 'PL', 'GRC': 'GR', 'PRT': 'PT',
    'IRL': 'IE', 'CZE': 'CZ', 'HUN': 'HU', 'RUS': 'RU',
    'KOR': 'KR', 'SGP': 'SG', 'HKG': 'HK', 'ARE': 'AE',
    'ISR': 'IL', 'EGY': 'EG', 'ZAF': 'ZA', 'ARG': 'AR',
    'TUR': 'TR', 'UKR': 'UA', 'ROU': 'RO', 'BGR': 'BG',
    'HRV': 'HR', 'SRB': 'RS', 'SVK': 'SK', 'SVN': 'SI',
    'LTU': 'LT', 'LVA': 'LV', 'EST': 'EE', 'ISL': 'IS',
    'LUX': 'LU', 'MLT': 'MT', 'CYP': 'CY', 'NZL': 'NZ',
    'CHL': 'CL', 'COL': 'CO', 'PER': 'PE', 'VEN': 'VE',
    'SAU': 'SA', 'TWN': 'TW', 'THA': 'TH', 'MYS': 'MY',
    'IDN': 'ID', 'PHL': 'PH', 'VNM': 'VN'
};
                    ...
                    <Geographies geography={geoUrl}>
                        {({ geographies }) =>
                            geographies.map((geo) => {
                                ...
                                const code2 = iso3to2[isoCode] || // Convert 3-letter to 2-letter
