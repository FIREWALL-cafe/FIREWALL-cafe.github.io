...
const VoteAnalytics = () => {
        ...
        datasets: [
            {
                ...
                backgroundColor: data.voteCategories.filter(cat => cat.count > 0).map(cat => cat.color + 'CC'),
    ...
    const timelineData = {
        labels: data.voteTimeline.map(item => 
        ...
        switch (activeChart) {
            ...
            case 'distribution':
                return data.totalVotes > 0 ? 
                    ...
                    <div className="h-48 flex items-center justify-center text-gray-500">No vote data available</div>;
            case 'timeline':
                return data.voteTimeline.length > 0 ? 
                    <Line data={timelineData} options={commonOptions} /> :
                    <div className="h-48 flex items-center justify-center text-gray-500">No timeline data available</div>;
            case 'controversial':
                return (
