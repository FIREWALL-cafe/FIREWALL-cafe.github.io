      ...
      <div className="flex flex-wrap flex-1 shrink gap-10 justify-center w-full basis-0 max-md:max-w-full">
        <div className="flex flex-col flex-1 shrink my-auto basis-0">
          <div className="flex flex-col w-full max-md:max-w-full">
            ...
            <a href="/editorial/lan-yu" className="flex gap-1 justify-center items-center self-start px-4 mt-10 text-xl text-center text-red-600 bg-white rounded border border-red-600 border-solid min-h-[56px]">
